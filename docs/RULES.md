...
- Preserve available source resolution by default; allow publisher and viewer quality ceilings that reduce resolution, frame rate, and bitrate. Favor resolution over frame rate under pressure by default; allow publisher preferences and per-viewer overrides for detail, motion, or balanced priority, plus audio bitrate ceilings. Explain measured quality honestly. Connection attribution must be labeled as an estimate; insufficient evidence must remain unknown.
